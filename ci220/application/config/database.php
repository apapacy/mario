...
$db['default']['password'] = '26682316';
$db['default']['database'] = 'sqlite3:./db.sqlite';
...
(
  ...
  ip_address character varying(45) NOT NULL DEFAULT '0'::character varying,
...
CREATE INDEX last_activity_idx
  ...
  USING btree
  (last_activity);
COMMENT ON INDEX last_activity_idx
  IS 'CREATE TABLE IF NOT EXISTS  `ci_sessions` (
