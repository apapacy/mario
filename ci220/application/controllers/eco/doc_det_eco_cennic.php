...
*/
 const TABLE = 'doc_det', VIEW = 'doc_det_eco_cennic_view',
 PAGE_LENGTH = 17;
 
 public static $FIELDS =  array( 'kod','npp','kodiz','koddet',
               'kodiz_name','koddet_name',
			   'depstk', 'ec_depstk',
			   'nop','kol','cen','ec_cen');
 public static $ORDER =  array( 'kod', 'npp' );
 public static $UPDATABLE =  array( 'kod','npp','kodiz','koddet', 'depstk','nop','kol','cen');
