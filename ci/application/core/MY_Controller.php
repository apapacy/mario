...
class MY_BaseREST_Controller extends MY_Controller {
...
class MY_SimpleREST_Controller extends MY_REST_Controller {

  const NEXT_ID = '';

  public function create( $print = true ) {
    if ( static::NEXT_ID === 'NEXT' )
      return parent::_create_with_next_id(static::$FIELDS, 'id', $print );
    else if ( static::NEXT_ID === 'USER' )
      return parent::_create_with_id(static::$FIELDS, 'id', $print );
    else
      return parent::_create(static::$FIELDS, 'id', $print );
  }

  public function read( $id, $print = true ) {
    return parent::_read(static::$FIELDS, $id, 'id', $print );
  }

  public function update( $id, $print = true ) {
  	parent::_update( static::$FIELDS, $id, 'id' , $print );
  }
...
class MY_REST_controller extends MY_BaseREST_Controller {
